...
namespace CompanyManagement.Tests.ITSupportManagementService.Tests.Unit
{
    public class UserMessageHandlerTests
    {
        ...
        public void Process_Should_Create_New_User_When_Message_NotIsEmpty()
        {
            ...
            employeeBusinessLogic.Received(1).HandleRegistrationAsync(Arg.Any<EmployeeDto>());
        }
        ...
        public void Process_Should_Throw_Argument_Null_Exception_When_Message_IsEmpty(string? message)
        {
            ...
            employeeBusinessLogic.Received(0).HandleRegistrationAsync(Arg.Any<EmployeeDto>());
        }
    }
}